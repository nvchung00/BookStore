...
/*     //Send email
    if (!$firstName && !$lastName && !$email && !$subject && !$website && !$message) {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = "nvchung00@gmail.com"; // Your Email Address
        $mail->Password = "a8726357"; // Your Password
        $mail->Port = 587;
        ...
        $mail->addAddress("nvchung00@gmail.com"); //Recipient name is optional
